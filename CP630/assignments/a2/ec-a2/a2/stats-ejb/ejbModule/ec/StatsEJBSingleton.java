...
public class StatsEJBSingleton implements StatsEJBSingletonRemote, StatsEJBSingletonLocal {
    ...
    public StatsEJBSingleton(StatsSummary sm) {
    	if (sm.data instanceof ArrayList<?>) {
    		this.data = sm.data;
    	} else {
    ...
    public StatsSummary getData() {
    	StatsSummary sm = new StatsSummary(this.data, this.count, this.min, this.max, this.mean, this.std);
    	return sm;
    }
	...
	public void saveModel() {
		try {
			...
			StatsSummary ss = new StatsSummary(this.data, this.count, this.min, this.max, this.mean, this.std);
